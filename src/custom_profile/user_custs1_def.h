...
#define DEF_SVC1_LED_STATE_CHAR_LEN      100
...
////////////////////////////DANLAW CONFIGURATION///////////////////////////////////////



#define DEF_APP_SEND_CHAR_LEN 						250
...
#define DEF_SPPLE_SERVICE_UUID_128				{0x39,0x23,0xCF,0x40,0x73,0x16,0x42,0x9A,0x5C,0x41,0x7E,0x7D,0xC4,0x9A,0x83,0x14}

#define DEF_APP_SEND_DATA_UUID_128 				{0xA3,0xE1,0x26,0x0A,0xEE,0x9A,0xE9,0xBB,0xB0,0x49,0x0B,0xEB,0xE7,0xAC,0x00,0x8B}
//#define DEF_APP_SEND_DATA_UUID_128 				{0x8B,0x00,0xAC,0xE7,0xEB,0x0B,0x49,0xB0,0xBB,0xE9,0x9A,0xEE,0x0A,0x26,0xE1,0xA3}

#define DEF_BLE_SEND_DATA_UUID_128				{0x57,0x9A,0x05,0x43,0x52,0xCD,0xB1,0xA6,0x1A,0x4B,0xE7,0xA8,0x4A,0x59,0x34,0x07}
//#define DEF_BLE_SEND_DATA_UUID_128				{0x07,0x34,0x59,0x4A,0xA8,0xE7,0x4B,0x1A,0xA6,0xB1,0xCD,0x52,0x43,0x05,0x9A,0x57}

#define DEF_AUTH_UUID_128									{0x61,0x63,0x69,0x74,0x6E,0x65,0x68,0x74,0x75,0x61,0x77,0x61,0x6C,0x6E,0x61,0x64}
//#define DEF_AUTH_UUID_128									{0x64,0x61,0x6E,0x6C,0x61,0x77,0x61,0x75,0x74,0x68,0x65,0x6E,0x74,0x69,0x63,0x61}

#define DEF_APP_SEND_USER_DESC  					"[SERVICE]App Send Data to BLE"

#define DEF_BLE_SEND_USER_DESC  					"[SERVICE]BLE Send Data to App"

#define DEF_AUTH_USER_DESC								"[SERVICE]Authentication"
